...
class mail_html_bbcode {
	...
	var $tags = array(
		'*'       => 'mail_html_bb_li',
		'a'       => 'mail_html_bb_a',
		'abbr'    => 'mail_html_bb_abbr',
		'acronym' => 'mail_html_bb_acronym',
		'address' => 'mail_html_bb_address',
		'align'   => 'mail_html_bb_align',
		'anchor'  => 'mail_html_bb_a',
		'b'       => 'mail_html_bb_strong',
		'bbcode'  => 'mail_html_bb_bbcode',
		'caption' => 'mail_html_bb_caption',
		'center'  => 'mail_html_bb_align',
		'code'    => 'mail_html_bb_code',
		'color'   => 'mail_html_bb_color',
		'email'   => 'mail_html_bb_email',
		'font'    => 'mail_html_bb_font',
		'google'  => 'mail_html_bb_google',
		'h1'      => 'mail_html_bb_h1',
		'h2'      => 'mail_html_bb_h2',
		'h3'      => 'mail_html_bb_h3',
		'hr'      => 'mail_html_bb_hr',
		'i'       => 'mail_html_bb_i',
		'img'     => 'mail_html_bb_img',
		'justify' => 'mail_html_bb_align',
		'left'    => 'mail_html_bb_align',
		'list'    => 'mail_html_bb_list',
		'nobb'    => 'mail_html_bb_nobb',
		'php'     => 'mail_html_bb_php',
		'quote'   => 'mail_html_bb_quote',
		'right'   => 'mail_html_bb_align',
		's'       => 'mail_html_bb_del',
		'size'    => 'mail_html_bb_size',
		'strike'  => 'mail_html_bb_del',
		'sub'     => 'mail_html_bb_sub',
		'sup'     => 'mail_html_bb_sup',
		'table'   => 'mail_html_bb_table',
		'td'      => 'mail_html_bb_td',
		'th'      => 'mail_html_bb_th',
		'tr'      => 'mail_html_bb_tr',
		'tt'      => 'mail_html_bb_tt',
	...
	function mail_html_bbcode($code = '') {
		if (is_array($code)) {
			$is_tree = false;
	...
	function highlight() {
		$chars = array(
			'@l;'  => '<span class="mail_html_bb_spec_char">@l;</span>',
			'@r;'  => '<span class="mail_html_bb_spec_char">@r;</span>',
			'@q;'  => '<span class="mail_html_bb_spec_char">@q;</span>',
			'@a;'  => '<span class="mail_html_bb_spec_char">@a;</span>',
			'@at;' => '<span class="mail_html_bb_spec_char">@at;</span>'
		);
		$uri = "[\w\d-]+\.[\w\d-]+[^\s<\"\']*[^.,;\s<\"\'\)]+";
		$search = array(
			"'(.)((http|https|ftp)://".$uri.")'si",
		...
		$replace = array(
			'$1<span class="mail_html_bb_autolink">$2</span>',
			'$1<span class="mail_html_bb_autolink">$2</span>',
			'$1<span class="mail_html_bb_autolink">$2</span>'
		);
		$str = '';
			...
			if ('text' == $elem['type']) {
				...
				foreach ($this -> mnemonics as $mnemonic => $value) {
					$elem['str'] = str_replace(
						$mnemonic,
						'<span class="mail_html_bb_mnemonic">'.$mnemonic.'</span>',
						$elem['str']
					);
				}
				...
				$str .= '<span class="mail_html_bb_tag">';
				foreach ($elem['layout'] as $val) {
					switch ($val[0]) {
						case 0:
							$str .= '<span class="mail_html_bb_bracket">'.$val[1]
								.'</span>';
							break;
						case 1:
							$str .= '<span class="mail_html_bb_slash">/</span>';
							break;
						case 2:
							$str .= '<span class="mail_html_bb_tagname">'.$val[1]
								.'</span>';
							break;
						case 3:
							$str .= '<span class="mail_html_bb_equal">=</span>';
							break;
						case 4:
							$str .= $val[1];
							break;
						case 5:
							if (! trim($val[1])) {
								...
								$str .= '<span class="mail_html_bb_quote">'.$val[1]
									.'</span>';
							}
							break;
						case 6:
							$str .= '<span class="mail_html_bb_attrib_name">'
						...
						case 7:
							if (! trim($val[1])) {
								...
								$str .= '<span class="mail_html_bb_attrib_val">'
		...
		$str = nl2br($str);
		$str = str_replace('  ', '&nbsp;&nbsp;', $str);
		return '<code class="mail_html_bb_code">'.$str.'</code>';
	}
		...
		foreach ($elems as $elem) {
			if ('text' == $elem['type']) {
				...
				if (class_exists($handler)) {
					...
					$result .= mail_html_bbcode::get_html($elem['val'], $quotes);
				}
			}
		}
		return $result;
...
class mail_html_bb_a extends mail_html_bbcode {
	var $ends = array(
...
// Класс для тега [abbr]
class mail_html_bb_abbr extends mail_html_bbcode {
	var $ends = array(
...
class mail_html_bb_acronym extends mail_html_bbcode {
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
	);
...
class mail_html_bb_address extends mail_html_bbcode {
	var $rbr = 1;
...
class mail_html_bb_align extends mail_html_bbcode {
	var $rbr = 1;
	var $ends = array('*','tr','td','th');
	function get_html() {
		$align = '';
...
class mail_html_bb_bbcode extends mail_html_bbcode {
	var $ends = array();
	var $children = array();
	function get_html() {
		$str = '';
...
class mail_html_bb_caption extends mail_html_bbcode {
	var $ends = array('tr');
	var $children = array(
...
// Класс для тега [code]
class mail_html_bb_code extends mail_html_bbcode {
	var $ends = array();
	var $children = array();
	function get_html() {
		$str = '<code class="bb">';
...
class mail_html_bb_color extends mail_html_bbcode {
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
	);
...
class mail_html_bb_del extends mail_html_bbcode {
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
	);
...
class mail_html_bb_email extends mail_html_bbcode {
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
	);
...
// Класс для тега [font]
class mail_html_bb_font extends mail_html_bbcode {
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
	);
...
class mail_html_bb_google extends mail_html_bbcode {
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
	);
	...
	function get_html() {
		...
		$target = isset($this -> attrib['target']) ? $this -> attrib['target'] : '';
		if ($target) { $attr .= ' target="'.htmlspecialchars($target).'"'; }
		return '<a class="mail_html_bb_google" '.$attr.'>'.parent::get_html($this -> tree).'</a>';
	}
}

// Класс для тега [h1]
class mail_html_bb_h1 extends mail_html_bbcode {
	var $lbr = 1;
	var $rbr = 2;
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
...
// Класс для тега [h2]
class mail_html_bb_h2 extends mail_html_bbcode {
	var $lbr = 1;
	var $rbr = 2;
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
...
// Класс для тега [h3]
class mail_html_bb_h3 extends mail_html_bbcode {
	var $lbr = 1;
	var $rbr = 2;
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
...
// Класс для тега [hr]
class mail_html_bb_hr extends mail_html_bbcode {
	var $is_close = true;
	var $rbr = 1;
	var $ends = array();
	var $children = array();
...
// Класс для тега [i]
class mail_html_bb_i extends mail_html_bbcode {
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
	);
...
// Класс для тега [img]
class mail_html_bb_img extends mail_html_bbcode {
	var $ends = array();
	var $children = array();
	function get_html() {
		$attr = 'alt=""';
...
// Класс для тега [*]
class mail_html_bb_li extends mail_html_bbcode {
	var $ends = array('*','tr','td','th');
	function get_html() {
		$attrib = 'class="bb"';
		if ('' !== $this -> attrib['*']) {
...
// Класс для тега [list]
class mail_html_bb_list extends mail_html_bbcode {
	var $lbr = 0;
	var $rbr = 2;
	var $ends = array();
	var $children = array('*');
...
// Класс для тега [nobb]
class mail_html_bb_nobb extends mail_html_bbcode {
	var $ends = array();
	var $children = array();
	function get_html() {
		$str = '';
...
// Класс для тега [php]
class mail_html_bb_php extends mail_html_bbcode {
	var $ends = array();
	var $children = array();
	function get_html() {
		$str = '';
...
class mail_html_bb_quote extends mail_html_bbcode {
	var $rbr = 1;
	var $ends = array();
	function get_html(&$quotes) {
		...
		if ($author = htmlspecialchars($this -> attrib['quote'])) {
			...
			if ( $post->getId() !== null ) {
				...
				$return =
						'<div style="border-left: 1px solid #3F3F3F; padding-left: 20px; padding-top: 10px;">'.
						'------------Original Message------------<br>'.
						'Subject : RE:'.$post->getTopic()->getSubject().'<br>'.
						'Date : '.$date->get(Zend_Date::RFC_2822).'<br>'.
						'From : '.$post->getAuthor()->getFirstname().' '.$post->getAuthor()->getLastname().' &lt;'.$post->getAuthor()->getEmail().'&gt;<br>'.
						'Reply-To : '.$post->getTopic()->getDiscussion()->getTitle().' &lt;'.$post->getTopic()->getDiscussion()->getFullEmail().'&gt;<br>'.
						'<div style="padding-left: 3px;">'.$tmpQuote['text'].'</div>'.
						'</div>'.
						'';
			} else {
				$return =
...
// Класс для тега [size]
class mail_html_bb_size extends mail_html_bbcode {
	/*
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
...
// Класс для тега [b]
class mail_html_bb_strong extends mail_html_bbcode {
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
	);
...
// Класс для тега [sub]
class mail_html_bb_sub extends mail_html_bbcode {
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
	);
...
// Класс для тега [sup]
class mail_html_bb_sup extends mail_html_bbcode {
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
	);
...
class mail_html_bb_table extends mail_html_bbcode {
	var $rbr = 1;
...
// Класс для тега [td]
class mail_html_bb_td extends mail_html_bbcode {
...
// Класс для тега [th]
class mail_html_bb_th extends mail_html_bbcode {
	var $ends = array('td','th','tr');
	function get_html() {
		$attr = ' class="bb"';
		$width = isset($this -> attrib['width']) ? $this -> attrib['width'] : '';
...
// Класс для тега [tr]
class mail_html_bb_tr extends mail_html_bbcode {
	var $ends = array('tr');
...
// Класс для тега [tt]
class mail_html_bb_tt extends mail_html_bbcode {
	var $ends = array(
		'*','address','align','center','h1','h2','h3','hr','justify',
		'left','list','php','quote','right','table','td','th','tr'
	);
...
// Класс для тега [u]
class mail_html_bb_u extends mail_html_bbcode {
	var $ends = array(
