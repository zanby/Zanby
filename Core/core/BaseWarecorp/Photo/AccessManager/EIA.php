...
class BaseWarecorp_Photo_AccessManager_EIA extends Warecorp_Photo_AccessManager
{
    ...
    /**
     * @return Warecorp_Photo_AccessManager_EIA
     */
    ...
    public static function canViewGallery($gallery, $context, $user) {
        if ( $context instanceof Warecorp_Group_Simple ) {
            return parent::canViewGallery($gallery, $context, $user) || self::isOwnerEIA($context, $user);
        }
