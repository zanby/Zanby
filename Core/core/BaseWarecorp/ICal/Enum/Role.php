...
class BaseWarecorp_ICal_Enum_Role
{
	...
	const NON_PARTICIPANT       = "NON-PARTICIPANT";    // Indicates a participant who is copied for information
	...
	{
		$class = new ReflectionClass('Warecorp_ICal_Enum_Role');
		if ( !in_array($value, $class->getConstants()) ) return false;
		return true;    
	}
