...
class BaseWarecorp_ICal_Timezone_List extends Warecorp_ICal_List_Abstract 
{
	/**
	 * Constructor
	...
	public function getList()
	{
		...
		if ( $this->getFetchMode() == Warecorp_ICal_List_Enum_FetchMode::OBJECT ) {
			...
			*/
			...
			$query->from('calendar_timezones', array($this->getPairsModeKey(), $this->getPairsModeValue()));
