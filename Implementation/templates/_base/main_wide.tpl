...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{$AppTheme->css}/main_wide.css" media="screen" />
	...
	<!-- komarovski TODO put this script to correct place -->
	<script type="text/javascript" src="{$JS_URL}/yui/dragdrop/dragdrop.js" ></script>


    <!-- thickbox -->
    <link rel="stylesheet" type="text/css" href="{$AppTheme->css}/thickbox.css" media="screen" />
    <script type="text/javascript" src="{$AppTheme->common->js}/jquery/jquery-1.3.2.min.js" ></script>
...
<div class="prLayout-content prClr"><div class="prLayout-inner">
    <div class="prContent"><div class="prContent-inner">
			...
			{/if}
		<div class="prContentBlock{if $isRightBlockHidden} prSingular{/if}"><div class="prContentBlockInner">
			{ButtonPanel}
			...
			<div class="prWideContentLeft">
				{include file=$bodyContent}
			</div>
			<div class="prWideContentRight">
                {Widget_Login}{/Widget_Login}
                {Widget_CO_Buttons}{/Widget_CO_Buttons}
				{Widget_GlobalSearch tags=$tagsList}{/Widget_GlobalSearch}
                {Widget_Right_Custom}{/Widget_Right_Custom}			
			</div>
		</div></div>
...
{* jQuery for DropDown Nav *}{literal}
<script type="text/javascript"> 
...
{/literal}{* END jQuery for DropDown Nav *}
...
<div class="prPopUp2" style="visibility:hidden; display:none; position:absolute;" id="ajaxMessageAlert">
