 ...
 <div class="prClr3">
	<!-- left column begin -->
		...
		<div class="prThemeEditorRightBlock" id="theme_defaults_div">
			...
			<p class="prFloatLeft prInnerTop">{t}The content block defaults manage the starting formatting settings<br />of all your Drag and Drop content objects.{/t}</p>
			<div class="prFloatRight prIndentTop">
			{t var='button_01'}Save Changes{/t}
			{linkbutton name=$button_01 link="#" onclick="xajax_themeSave(ThemeApplication.getParamsDS(), ThemeApplication.clearOldLayoutCh()); ThemeApplication.makeBackupDefaults();"}</div>			
			...
			<!-- slot -->
				...
				<h3 class="prInnerTop prInnerBottom">{t}Headline Text{/t}</h3>
              	<div class="prInnerBottom">
					<select id="headlineTextStyleSelector" class="" onchange="ThemeApplication.applyHeadlineTextStyle(this.value)">
                  	...
                  	<p id="headlineTextColorIndicator" style="color:{$theme->headlineTextColor};" class="prIndentTopSmall">{t}Headline Text{/t}</p>                  
				</div>
              	<!-- /slot -->
              	...
              	<div class="prInnerBottom">
					<select class="" id="bodyTextStyleSelector" onchange="ThemeApplication.applyBodyTextStyle(this.value)">
					...
					<p id="bodyTextColorIndicator" style="color:{$theme->bodyTextColor};" class="prIndentTopSmall">{t}Body Text{/t}</p>                  
              	</div>
              	<!-- /slot -->
              	...
              	<div class="prInnerBottom">
                  	<select class="" id="commentTextStyleSelector" onchange="ThemeApplication.applyCommentTextStyle(this.value)">
                  	...
                  	<div id="commentColorIndicator" style="color:{$theme->commentColor};" class="prIndentTopSmall">{t}Accent Text{/t}</div>
				</div>
              	<!-- /slot -->
              	...
              	<div class="prInnerBottom">
					<select class="" id="headerTextStyleSelector" onchange="ThemeApplication.applyHeaderTextStyle(this.value)">
                  	...
                  	<h3 id="headerColorIndicator" style="color:{$theme->headerColor};" class="prIndentTopSmall">{t}Section Header{/t}</h3>                
              	</div>
              	<!-- /slot -->
            ...
            <div id="outlineColorIndicator2">
                ...
                <h2 class="prInner"><strong>{t}Default Headline{/t}</strong></h2>
                <!-- /content object default headline -->
            ...
            <div class="prInnerTop prInnerBottom prClearer">
              <input type="checkbox" id="clearOldLayout" /> <label for="clearOldLayout">{t}Apply changes to saved layout{/t}</label>
          	</div>           
			
			<div class="prInnerTop prTRight prButtonPanel">
			{t var='button_02'}Save Changes{/t}
				{linkbutton name=$button_02 link="#" onclick="xajax_themeSave(ThemeApplication.getParamsDS(), ThemeApplication.clearOldLayoutCh()); ThemeApplication.makeBackupDefaults(); "}&nbsp;
			{t var='button_03'}Clear Edits{/t}
				{linkbutton name=$button_03 link="#" onclick="ThemeApplication.restoreColors();"}			
			</div>        
    	...
    	<div class="prThemeEditorRightBlock" id="theme_background_div" style="display:none;">
           
				<h2 class="prFloatLeft">{t}Edit the background of your Profile Page{/t}</h2> 	 
				{* <div class="prFloatRight prIndentTop">{linkbutton name="Save Changes" link="#" onclick="xajax_themeSave(ThemeApplication.getParamsBS(), 0); ThemeApplication.makeBackupBackground();"}</div>	*}		
          
          	<div class="prClearer prInner prClr">
			<!-- setting box begin -->
				  ...
				  <!-- slot -->
					...
					<div class="prInnerBottom prClr3">
						...
						<div style="display:{if $theme->backgroundUrl}block{else}none{/if}" id="avatarinfoblock">
							<input type="checkbox" class="prNoBorder" id="backgroundTileCh" {if $theme->backgroundTile}checked="checked"{/if} onclick="ThemeApplication.changeBackgrouundTile();" /> <label for="backgroundTileCh">{t}Tile{/t}</label>
							<div class="prInnerTop">
								...
								<img src="{$AppTheme->images}/decorators/profile-marker.gif" onclick="ThemeApplication.removeBackgroundImage();" align="top" />
								</div>
							</div>
						</div>
					</div>
				...
				{t var='button_04'}Save Changes{/t}
					{linkbutton name=$button_04 link="#" onclick="xajax_themeSave(ThemeApplication.getParamsBS(), 0); ThemeApplication.makeBackupBackground();"}&nbsp;
					{t var='button_05'}Clear Edits{/t}
					{linkbutton name=$button_05 link="#" onclick="ThemeApplication.restoreBackground();"}
				</div>	
		</div>		
	</div>
	 
<script type="text/javascript" src="{$JS_URL}/ThemeApplication.js" ></script>
