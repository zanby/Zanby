...
<table class="prForm">
    ...
    {if $video->getSource() == 'nonvideo'}
        <tr>
            <td class="prTRight"><label for="customSrcImg">{t}Thumbnail{/t}</label></td>
              <td>
                {form_file id="customSrcImg" name="customSrcImg" size="44"}
              </td>
        </tr>
    {else}
        <tr>
        ...
        <tr>
            <td class="prTRight"><label for="videoTitle">{t}Thumbnail{/t}</label></td>
    ...
    <tr>
        ...
        <div class="prInnerTop prTCenter">
            ...
            <span class="prIEVerticalAling"><span class="prIndentLeftSmall">{t}or{/t}</span><a class="prIndentLeftSmall" href="#null"onclick="tinyMCE.execCommand( 'mceRemoveControl', true, 'videoDescription'); {$JsApplication}.hideEditPhotoPanel(); return false;">{t}Cancel{/t}</a></span>
        </div>
{/form}
{*popup_item*}
<!-- /user content -->
