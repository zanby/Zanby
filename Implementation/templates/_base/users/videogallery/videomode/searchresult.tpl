...
<div>
    ...
    <div class="prInnerBottom">
		<h3>{if $keywords != ""}{t}Videos about{/t}{else}{t}Videos{/t}{/if} {$keywords|escape:"html"} {t}Uploaded By{/t} {$whoUploadedByString}</h3>
        ...
        <!-- search result begin -->
            <div>
				<div class="prIndentBottom">
	      		...
	      		<!--{if $smarty.foreach.videos.first}<ul class="">{/if}-->
