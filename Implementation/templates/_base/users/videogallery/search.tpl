        ...
        <div class="prIndentBottom prInnerTop">
            ...
            {if $videosList.friends}
                <div class="prInnerSmallTop">
                    <div>{t}{tparam value=$currentUser->getUserPath('videossearch')}From <a href="%spreset/new/whouploaded/2/sort/1">My Friends{/t}</a></div>
					<div class="prClr2">
                    {foreach item=p name='videos' from=$videosList.friends}
                        <div class="prFloatLeft">
                            ...
                            <script>
                                YAHOO.example.container.img_{$p->getId()}friendsX = new YAHOO.widget.Tooltip("img_{$p->getId()}friendsX", {$smarty.ldelim}hidedelay:100, width:200, context:"img_{$p->getId()}friends", text:"{$p->getGallery()->getTitle()|nl2br|escape:javascript} Collection<br />{$p->getDescription()|nl2br|escape:javascript}"{$smarty.rdelim});
                            </script>
                        </div>
                    {foreachelse}
            ...
            {if $videosList.groups}
               <div class="prInnerSmallTop">
                    <div>{t}{tparam value=$currentUser->getUserPath('videossearch')}From <a href="%spreset/new/whouploaded/3/sort/1">My Groups</a>{/t}</div>
					<div class="prClr2">
                    {foreach item=p name='videos' from=$videosList.groups}
                        <div class="prFloatLeft">
                            ...
                            <script>
                                YAHOO.example.container.img_{$p->getId()}groupsX = new YAHOO.widget.Tooltip("img_{$p->getId()}groupsX", {$smarty.ldelim}hidedelay:100, width:200, context:"img_{$p->getId()}groups", text:"{$p->getGallery()->getTitle()|nl2br|escape:javascript} Collection<br />{$p->getDescription()|nl2br|escape:javascript}"{$smarty.rdelim});
                            </script>
                        </div>
                    {foreachelse}
			...
			{if $videosList.families}
                <div class="prInnerSmallTop">
                    <div>{t}{tparam value=$currentUser->getUserPath('videossearch')}From <a href="%spreset/new/whouploaded/4/sort/1">My Group Families</a>{/t}</div>
					<div class="prClr2">
                    {foreach item=p name='videos' from=$videosList.families}
                        <div class="prFloatLeft">
                            ...
                            <script>
                                YAHOO.example.container.img_{$p->getId()}familiesX = new YAHOO.widget.Tooltip("img_{$p->getId()}familiesX", {$smarty.ldelim}hidedelay:100, width:200, context:"img_{$p->getId()}families", text:"{$p->getGallery()->getTitle()|nl2br|escape:javascript} Collection<br />{$p->getDescription()|nl2br|escape:javascript}"{$smarty.rdelim});
                            </script>
                        </div>
                    {foreachelse}
            ...
            {if $videosList.anyone}
                <div class="prInnerSmallTop">
                    <div>{t}{tparam value=$currentUser->getUserPath('videossearch')}From <a href="%spreset/new/whouploaded/1/sort/1">Anyone</a>{/t}</div>
					<div class="prClr2">
                    {foreach item=p name='videos' from=$videosList.anyone}
                        <div class="prFloatLeft">
                            ...
                            <script>
                                YAHOO.example.container.img_{$p->getId()}anyX = new YAHOO.widget.Tooltip("img_{$p->getId()}anyX", {$smarty.ldelim}hidedelay:100, width:200, context:"img_{$p->getId()}any", text:"{$p->getGallery()->getTitle()|nl2br|escape:javascript} Collection<br />{$p->getDescription()|nl2br|escape:javascript}"{$smarty.rdelim});
                            </script>
                        </div>
