...
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCProfileDetails.class.js"></script>
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCMyGroups.class.js"></script>
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCPicture.class.js"></script>
...
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCMyFriends.class.js"></script>
...
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCMyVideoContentBlock.class.js"></script>
...
<script type="text/javascript" src="{$JS_URL}/SWFUpload/swfuploadcode.js"></script>
<script type="text/javascript" src="{$JS_URL}/SWFUpload/swfupload.graceful_degradation.js"></script>  
<!--<script type="text/javascript" src = "/js/content_objects/color_picker.js"></script>-->
...
<script>
    ...
    {
        setUploadURL("{/literal}{$currentUser->getUserPath('avatarupload/swf/1')}{literal}");
        setPostParams({{/literal}"SWFUploadID" : '{$SWFUploadID}', "user" : '{$currentUser->getId()}'{literal}});
...
<script type="text/javascript">
        var CODescriptionText = null;
        var COHeadlineText = null;
		tinyMCE.init({
			mode : "textareas",
			theme : "headline",
	...
	function tinyMCEInit(id){
		...
		var _tmpres = tinyMCE.execCommand('mceAddControl', true, id);
	//	alert (String(id).substr(8,String(id).length-8));
