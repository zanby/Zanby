...
{assign var="allowDisplayListToGuest" value=0}
        ...
        {else}
            ...
            {/if}
        {/if}
<div class="prClr3 prIndentTop prEvents-att-BottomBlock">
...
{t var='button'}Close Attendance Details{/t}
            {linkbutton name=$button onclick="popup_window.close();return false;"}
</div>
{*popup_item*}
