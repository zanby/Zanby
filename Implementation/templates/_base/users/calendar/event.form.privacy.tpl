			<div class="prToggleArea">
				...
				<div id="sharing-options-full">
					...
					{form_radio name="event_privacy" id="event_privacy_1" value="1" checked=$formParams.event_privacy}<label for="event_privacy_1" class=""> {t}This event is private. This event is visible only to you and invited guests.{/t}</label>
					</div>
				</div>
