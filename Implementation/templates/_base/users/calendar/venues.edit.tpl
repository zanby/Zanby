<div class="prClr3"><table width="100%" border="0">
	<tr>
	...
	<tr>
		<td>{t}Phone:{/t}</td><td>{form_text name="event[venue_phone]" value=$venue->getPhone()|escape:html} Please include area code.</td>
	</tr>
