...
<div class="prInner">
    <div>
    	{$aSearches.find_page*10-9}-{if $countVenues > $aSearches.find_page*10}{$aSearches.find_page*10}{else}{$countVenues}{/if} of {$countVenues}
        ...
        {foreach from=$aoVenuesList item = venue}
        	<tr>
                ...
                {if $user->getId() == $venue->getOwnerId()  && $venue->getOwnerType() == "user"}
                	<a href="#" title="Edit" onclick="xajax_editVenue( {$venue->getId()}, 'f' ); return false;">
