...
{assign var="canCreateOwnerDocuments" value=$AccessManager->canCreateOwnerDocuments($currentUser, $currUser, $user->getId())}
	...
	<script>
        ...
        if ( !cfgDocumentApplication ) {
            cfgDocumentApplication = function () {
                return {
                    currentOwnerId  : {/literal}{$currUser->getId()}{literal},
					initDragDrop	: {/literal}{if $canManageOwnerDocuments}1{else}0{/if}{literal},
                    hAddFile        : '{/literal}{$currentUser->getUserPath("documentAdd")}{literal}',
                    hAddWeblink     : '{/literal}{$currentUser->getUserPath("documentAddWeblink")}{literal}',
                    hCreateFolder   : '{/literal}{$currentUser->getUserPath("documentCreateFolder")}{literal}',
                    hCheckIn       	: '{/literal}{$currentUser->getUserPath("documentCheckIn")}{literal}',
                    hCheckOut       : '{/literal}{$currentUser->getUserPath("documentCheckOut")}{literal}',
                    hCancelCheckOut : '{/literal}{$currentUser->getUserPath("documentCancelCheckOut")}{literal}',
                    hRevisions 		: '{/literal}{$currentUser->getUserPath("documentRevisions")}{literal}',
                    hRevertRevision : '{/literal}{$currentUser->getUserPath("documentRevertRevision")}{literal}',
                    hDeleteGroup    : '{/literal}{$currentUser->getUserPath("documentDeleteGroup")}{literal}',
                    hShare			: '{/literal}{$currentUser->getUserPath("documentShareFile")}{literal}',
                    hManageSharing	: '{/literal}{$currentUser->getUserPath("documentManageSharing")}{literal}',
                    hUnShare		: '{/literal}{$currentUser->getUserPath("documentUnshareFile")}{literal}',
                    hEdit       	: '{/literal}{$currentUser->getUserPath("documentEdit")}{literal}',
                    hMoveGroup      : '{/literal}{$currentUser->getUserPath("documentMoveGroup")}{literal}',
                    hAddToMy      	: '{/literal}{$currentUser->getUserPath("documentAddToMy")}{literal}'
                }
            }();
        };
...
<ul class="prDocTools">
	<li menu="moreactions" class="prDocTools-Left" {if !$canManageOwnerDocuments}style="display:none;"{/if}><a href="javascript:void(0);" id="lnkMoreActions"><span class="prDocSelect">{t}More Actions{/t}</span></a>
        <div class="fg-menu-hidden-menu" id="menuCheckInOut">
            <ul>
                ...
                <li action="checkout"><a href="javascript:void(0);" onclick="DocumentApplication.checkOut(); return false;">Check Out</a><span class="fg-menu-hidden-item">{t}Check Out{/t}</span></li>
	...
	<li menu="add-document" class="prDocTools-Right" {if !$canManageOwnerDocuments}style="display:none;"{/if}><a href="javascript:void(0);" id="lnkAddDocument"><img src="{$AppTheme->images}/documents/docAddDoc.gif" class="prVMiddle" width="16" height="16" /> <span class="prDocSelect">{t}Add Document{/t}</span></a>
	...
	{*if $user && $currentUser && $user->getId() && $currentUser->getId() && $currentUser->getId() != $user->getId()}
...
<table cellpadding="0" cellspacing="0" class="prTableDocs">
    ...
    <tr>
        ...
        <th id="sortTitle">
		<input type="checkbox" class="prNoBorder prIndentRight" name="checkAll" id="checkAll" value="1" onclick="DocumentApplication.onCheckAll();" />
		   <a href="javascript:void(0);" onclick="xajax_sort_files(DocumentApplication.currentOwnerId, DocumentApplication.currentFolderId, YAHOO.util.Dom.get('current_order').value, YAHOO.util.Dom.get('current_direction').value, 'title');">{t}Name{/t}</a>
        </th>
        <th id="sortNote">
            <a href="javascript:void(0);">{t}Notes{/t}</a>
        </th>
        <th id="sortUpdate" style="border-right:1px solid #CDD3D5;">
            <a href="javascript:void(0);" onclick="xajax_sort_files(DocumentApplication.currentOwnerId, DocumentApplication.currentFolderId, YAHOO.util.Dom.get('current_order').value, YAHOO.util.Dom.get('current_direction').value, 'update');">{t}Date{/t}</a>
        </th>
    </tr>
    <tr>
        <td class="prVTop"><div class="prFullWidth" id="tree_div_0"></div></td>
        <td valign="top" colspan="3" id="document_tree_content" class="{if !$foldersList && !$documentsList}prNodocsFrame{else}prDocsFilesFrame{/if} prVTop">
            {include file="users/documents/documents.content.template.tpl"}
        </td>
    </tr>
</table>
...
<div id="moveGroupPanel" style="visibility:hidden; display:none;">
    <div>
		...
		<table class="prForm">
            <tr>
                <td>
                    <div id="moveGroupPanelContent" style="height:300px; overflow:auto; border:1px solid #efefef; padding:5px">
            ...
            <tr>
                <td class="prTCenter">
                    <span>
					{t var='button_01'}Move{/t}
                    {linkbutton id="btnMoveGroupFormSubmit" name=$button_01}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnMoveGroupFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
                </td>
            </tr>
		</table>
        </form>
...
<div id="unshareFilePanel" style="visibility:hidden; display:none;">
	<div>
		...
		<table class="prForm">
            <tr>
                <td><p class="prTCenter prText2">{t}Are you sure you want unshare choosed documents?{/t}</p></td>
            </tr>
            <tr>
                <td class="prTCenter">
                    <span>
					{t var='button_02'}Unshare{/t}
                    {linkbutton id="btnUnshareFilesFormSubmit" name=$button_02}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnUnshareFilesFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
                </td>
            </tr>
		</table>
		</form>
		...
		<table class="prForm">
            ...
            <tr>
                <td class="prTCenter">
                    ...
                    {linkbutton id="btnGroupDeleteFormSubmit" name=$button_03}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnGroupDeleteFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
                </td>
            </tr>
		</table>
		</form>
...
<div id="deleteGroupAcceptPanel" style="visibility:hidden; display:none;">
	<div>
		...
		<table class="prForm">
            <tr>
                <td><p>
                	{t}Directory '<span id="groupdeleteaccept_foldername"></span>' in not empty!{/t} <br/>
                    {t}Do you want to delete it with all its files and subfolders?{/t}
                </p></td>
            </tr>
            <tr>
                <td class="prTCenter">
                    <span>
					{t var='button_04'}Delete All{/t}
                    {linkbutton id="btnGroupDeleteAcceptFormSubmit" name=$button_04}
                    </span> {t}or{/t}
					{t var='button_05'}Don't remove this folder{/t} 
					{linkbutton id="btnGroupDeleteAcceptFormCancel" name=$button_05}
                </td>
            </tr>
		</table>
		</form>
...
<div id="addToMyPanel" style="visibility:hidden; display:none;">
	<div>
		...
		<table class="prForm">
            <tr>
                <td><p class="prText2 prTCenter">{t}Are you sure you want add choosed documents to your documents?{/t}</p></td>
            </tr>
            <tr>
                <td class="prTCenter">
                    <span>
					{t var='button_06'}Add to My Documents{/t} 
                    {linkbutton id="btnAddtomySubmit" name=$button_06}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnAddtomyCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
                </td>
            </tr>
		</table>
		</form>
	...
	<div>
		...
		<table class="prForm">
            <tr id="addToMyAcceptMessageContainer">
                <td><p>
                	{t}Document with name '<span id="addtomyaccept_documentname"></span>' already exists!{/t} <br/>
                    {t}Please, enter different name to save document?{/t}
                </p></td>
            </tr>
            ...
            <tr>
                <td>
                    <label for="addtomyaccept_groups_accept_name">{t}Save As{/t}</label>
                    <div id="fields_table"><input type="text" maxlength="30" name="groups_accept_name" id="addtomyaccept_groups_accept_name"  /></div>
                </td>
            </tr>
            <tr>
                <td class="prTCenter">
                    <span>
					{t var='button_07'}Save Document{/t}
                    {linkbutton id="btnAddToMyAcceptFormSubmit" name=$button_07}
                    </span> {t}or{/t}
					{t var='button_08'}Don't save this document{/t} 
					{linkbutton id="btnAddToMyAcceptFormCancel" name=$button_08}
                </td>
            </tr>
		</table>
		</form>
...
<div id="addFolderPanel" style="visibility:hidden; display:none;">
	<div>
		...
		<tr>
			<td>
	        	<p class="prMarkRequired">{t}Note: Your folder will be added in the <span id="addFolderPanelFolderLabel">top level of Documents</span>{/t}</p>
	        </td>
		</tr>
		...
		<tr>
			<td>
	        	<label for="create_folder_name">{t}Folder Name{/t}</label>
                <div id="fields_table"><input type="text" maxlength="30" name="folder_name" id="create_folder_name"  /></div>
			</td>
		</tr>
		<tr>
			<td class="prTCenter">
                    <span>
					{t var='button_09'}Add Folder{/t}
                    {linkbutton id="btnNewFolderFormSubmit" name=$button_09}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnNewFolderFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
	        </td>
		</tr>
		</table>
		</form>
...
<div id="editFolderPanel" style="visibility:hidden; display:none;">
	<div class="bd">
		...
		<tr>
			<td>
	        	<label for="edit_folder_name">{t}Folder Name{/t}</label>
                <div id="fields_table"><input type="text" maxlength="30" name="folder_name" id="edit_folder_name"  /></div>
			</td>
		</tr>
		<tr>
			<td class="prTCenter">
                    <span>
					{t var='button_10'}Save Changes{/t}
                    {linkbutton id="btnEditFolderFormSubmit" name=$button_10}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnEditFolderFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
	        </td>
		</tr>
		</table>
		</form>
...
<div id="addFilePanel" style="display:none;">
	<div class="prFullWidth">
		...
		<div class="prClr3 prIndentTop prLargeFormItem prBlockCentered">
            ...
            <div id="fields_table"><input type="file" name="file" id="new_file" size="34" /></div>
            <div class="prIndentTopSmall"><div style="width: 20px; float:left;"><input type="checkbox" name="file_is_bulk" id="new_file_is_bulk" value="1" class="prNoBorder"></div><label for="new_file_is_bulk" class="prFloatLeft">{t}Bulk upload{/t}</label></div>
		</div>
	    <div class="prIndentTopSmall">
            {t}The bulk upload facility allows for a number of documents to be added to the document management system. Provide an archive (ZIP) file from your local computer, and all documents and folders within that archive will be added to the document management system.{/t}
	    </div>
	    <div class="prIndentTop prLargeFormItem prBlockCentered">	
            <label for="new_file_description">{t}Description{/t}</label><br />
            <textarea name="file_description" id="new_file_description" rows="5"></textarea>
	    </div>
		<div class="prIndentTop prLargeFormItem prBlockCentered">		
            <label for="new_file_tags">{t}Tags{/t}</label><br />
        ...
        {/if}
		<div class="prIndentTop prLargeFormItem prBlockCentered">
	        <input type="radio" name="file_privacy" id="new_file_privacy_private" value="1" class="prAutoWidth prNoBorder" /><label for="new_file_privacy_private"> {t}Private{/t}</label>
	        <input type="radio" name="file_privacy" id="new_file_privacy_public" value="0" checked="checked" class="prAutoWidth prNoBorder" /><label for="new_file_privacy_public"> {t}Public{/t}</label>
        </div>
		<div class="prTCenter">
			<span>
			{t var='button_11'}Add Document{/t}
			{linkbutton id="btnNewFileFormSubmit" name=$button_11}
			</span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnNewFileFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
	    </div>
		</form>
	</div>
</div>
<div id="editFilePanel" style="visibility:hidden; display:none;">
	<div>
	    ...
	    <tr>
			<td>
	        <label for="edit_file_description">{t}Description{/t}</label>
	        <textarea name="file_description" id="edit_file_description" rows="5"></textarea>
	        </td>
		</tr>
		<tr>
			<td>
	        <label for="edit_file_tags">{t}Tags{/t}</label>
		...
		<tr>
			<td>
	        <input type="radio" name="file_privacy" id="edit_file_privacy_private" value="1" class="prAutoWidth prNoBorder" /><label for="edit_file_privacy_private"> {t}Private{/t}</label>
	        <input type="radio" name="file_privacy" id="edit_file_privacy_public" value="0" checked="checked" class="prAutoWidth prNoBorder" /><label for="edit_file_privacy_public"> {t}Public{/t}</label>
	        </td>
		</tr>
		<tr>
			<td class="prTCenter">
                    <span>
					{t var='button_12'}Save Changes{/t}
                    {linkbutton id="btnEditFileFormSubmit" name=$button_12}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnEditFileFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
	        </td>
		</tr>
		</table>
		</form>
...
<div id="addWebLinkPanel" style="display:none;">
	<div>
		...
		<tr>
			<td>
	        	<p class="prMarkRequired">{t}Note: Your link will be placed in the <span id="addWebLinkPanelFolderLabel">top level of Documents</span>.{/t}</p>
	        </td>
		</tr>
		...
		<tr>
			<td>
	        	<label for="new_weblink">{t}URL{/t} {t}(e.g. link to a Google document, Zoho, etc.){/t}</label>
                <div id="fields_table"><input type="text" name="weblink" id="new_weblink" size="32" /></div>
			</td>
		</tr>
	    <tr>
			<td>
	        <label for="new_weblink_description">{t}Description{/t}</label>
	        <textarea name="weblink_description" id="new_weblink_description" rows="5"></textarea>
	        </td>
		</tr>
		<tr>
			<td>
	        <label for="new_weblink_tags">{t}Tags{/t}</label>
		...
		<tr>
			<td>
	        <input type="radio" name="weblink_privacy" id="new_weblink_privacy_private" value="1" class="prAutoWidth prNoBorder" /><label for="new_weblink_privacy_private"> {t}Private{/t}</label>
	        <input type="radio" name="weblink_privacy" id="new_weblink_privacy_public" value="0" checked="checked" class="prAutoWidth prNoBorder" /><label for="new_weblink_privacy_public"> {t}Public{/t}</label>
	        </td>
		</tr>
		<tr>
			<td class="prTCenter">
                    <span>
					{t var='button_13'}Add Document Link{/t}
                    {linkbutton id="btnNewWebLinkFormSubmit" name=$button_13}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnNewWebLinkFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
	        </td>
		</tr>
		</table>
		</form>
...
<div id="editWebLinkPanel" style="display:none;">
	<div>
		...
		<tr>
			<td>
	        	<label for="edit_weblink">{t}URL{/t} {t}(e.g. link to a Google document, Zoho, etc.){/t}</label>
                <div id="fields_table"><input type="text" name="weblink" id="edit_weblink" size="32" /></div>
			</td>
		</tr>
	    <tr>
			<td>
	        <label for="edit_weblink_description">{t}Description{/t}</label>
	        <textarea name="weblink_description" id="edit_weblink_description" rows="5"></textarea>
	        </td>
		</tr>
		<tr>
			<td>
	        <label for="edit_weblink_tags">{t}Tags{/t}</label>
		...
		<tr>
			<td>
	        <input type="radio" name="weblink_privacy" id="edit_weblink_privacy_private" value="1" class="prAutoWidth prNoBorder" /><label for="edit_weblink_privacy_private"> {t}Private{/t}</label>
	        <input type="radio" name="weblink_privacy" id="edit_weblink_privacy_public" value="0" checked="checked" class="prAutoWidth prNoBorder" /><label for="edit_weblink_privacy_public"> {t}Public{/t}</label>
	        </td>
		</tr>
		<tr>
			<td class="prTCenter">
                    <span>
					{t var='button_14'}Save Changes{/t}
                    {linkbutton id="btnEditWebLinkFormSubmit" name=$button_14}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnEditWebLinkFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
	        </td>
		</tr>
		</table>
		</form>
	...
	<div>
		...
		<table class="prForm">
            ...
            <tr>
                <td class="prTCenter">
                    <span>
					{t var='button_15'}Check In{/t}
                    {linkbutton id="btnCheckInFormSubmit" name=$button_15}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnCheckInFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
                </td>
            </tr>
		</table>
		</form>
...
<div id="checkOutPanel" style="display:none;">
	<div>
		...
		<table class="prForm">
            ...
            <tr>
                <td><span class="prTBold">{t}Reason{/t}</span></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="prTCenter">
                    <span>
					{t var='button_16'}Check Out{/t}
                    {linkbutton id="btnCheckOutFormSubmit" name=$button_16}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnCheckOutFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
                </td>
            </tr>
		</table>
		</form>
...
<div id="cancelCheckOutPanel" style="display:none;">
	<div>
		...
		<table class="prForm">
            <tr>
                <td><p class="prTCenter prText2">{t}Are you sure you want to Cancel Check Out?{/t}</p></td>
            </tr>
            <tr>
                <td class="prTCenter">
                    <span>
					{t var='button_17'}Cancel Check Out{/t}
                    {linkbutton id="btnCancelCheckOutFormSubmit" name=$button_17}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnCancelCheckOutFormCancel" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></span>
                </td>
            </tr>
		</table>
		</form>
	...
	<div>
		...
		<table class="prForm">
            ...
            <tr>
                <td class="prTCenter">
                    <span>
					{t var='button_18'}Revert Revision{/t}
                    {linkbutton id="btnRevertRevisionFormSubmit" name=$button_18}
                    </span> <span class="prIEVerticalAling">{t}or{/t} <a href="#" id="btnRevertRevisionFormCancel">{t}Cancel{/t}</a></span>
                </td>
            </tr>
		</table>
		</form>
