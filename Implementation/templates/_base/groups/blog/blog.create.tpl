    ...
    <div class="freeClass">
		...
		{form_errors_summary}
            <table class="prForm">
                ...
                <tbody>
                    <tr>
                        <td class="prTRight"><span class="prMarkRequired">*</span> <label for="login">{t}Subject:{/t}</label></td>
                        <td colspan="2">{form_text name="subject" value=$postData.subject|escape:html}</td>
                    </tr>
                    <tr>
                        <td colspan="3">{form_textarea name="content" id="content" value=$postData.content|escape:html}</td>
                    </tr>
                    <tr>
                        ...
                        <td class="prTip">
							...
							{t var="in_submit"}Save New Post{/t}
