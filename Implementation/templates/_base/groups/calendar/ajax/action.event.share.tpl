...
<p class="prMarkRequired prInnerSmallTop">[{t}<span class="prMarkRequired">Note:</span> Only groups which you host, or in which the
...
<div class="prInnerSmallTop">
	...
	{t var="in_button"}Share Event{/t}{linkbutton name=$in_button link="javascript:void(0)" onclick=$linkAjaxShareGroups}
</div>		
{else}
...
{t var="in_button_2"}Share Event{/t}{linkbutton name=$in_button_2 link="javascript:void(0)" onclick=$linkAjaxShareUsers}
</div>
{else}
	<p class="prInnerTop prMarkRequired">
	{if $friendsCount == 0}
...
<div class="prTCenter prInnerTop">
	{t var="in_button_3"}Cancel and Close Window{/t}{linkbutton name=$in_button_3 link="javascript:void(0)" onclick="popup_window.close(); return false;"}
</div>
{*popup_item*}