...
{if $groupsList}
	<div class="prInnerSmallTop">
		...
		{t var="in_button"}Unshare Event{/t}
		{linkbutton name=$in_button link="javascript:void(0)" onclick=$linkAjaxShareGroups}
	</div>
{else}
...
<div class="prInnerSmallTop">
	...
	{t var="in_button_2"}Unshare Event{/t}{linkbutton name=$in_button_2 link="javascript:void(0)" onclick=$linkAjaxShareUsers}
</div>
{else}
