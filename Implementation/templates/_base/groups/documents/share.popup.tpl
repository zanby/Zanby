		...
		<table class="prForm">
            <tr>
                <td><p class="prMarkRequired">
                    ...
                    the host to get permission to share your document{/t}
                </p></td>
            </tr>   
            {if $groupsList}  
                <tr>
                    <td>
                        ...
                        <div id="fields_table" class="freeClass">
                ...
                <tr>
                    <td>{t var="in_button"}Share Document{/t}{linkbutton id="btnShareDocumentToGroup" name=$in_button link="javascript:void(0)"}</td>
                </tr>
            {else}  
            	<tr>
                	<td>{t}<span class="prMarkRequired">Note: There are no groups for share this document</span>{/t}</td>
                </tr>  
            {/if}
            {if $friendsList}
                <tr>
                ...
                <tr>
                    <td>{t var="in_button_2"}Share Document{/t}{linkbutton id="btnShareDocumentToUser" name=$in_button_2 link="javascript:void(0)"}</td>
                </tr>
            {else}     
                <tr>
                    <td>{t}<span class="prMarkRequired">Note: There are no friends for share this document</span>{/t}</td>
                </tr>     
            {/if}
