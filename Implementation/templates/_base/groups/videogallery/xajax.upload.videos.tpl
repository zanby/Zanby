...
<div id="uploadVersion">
	...
	<table class="prForm">
		...
		<tr>
			...
			<span class="prIndentLeftSmall">{t}or{/t} <a href="#null" onClick="cancelupload(function (){$smarty.ldelim}cancelClick();{$smarty.rdelim}); return false;"><span>{t}Cancel{/t}</span></a></span>
			</div>
			</td>
		</tr> 
	</table>
	...
	<table class="prForm">
		...
		<col width="88%" />
		<tr>
			<td class="prTRight"><label for="files_box_height">{t}Upload Files:{/t}</label>
			</td>
			<td>
				<div id="flashUI1">
					...
					<div class="prClr2 prInnerSmall">												
							<div class="prFloatLeft">{t var="in_button"}Choose Files{/t}{linkbutton id = "browse" name=$in_button onclick="upload1.selectFiles(); return false;"}</div>						
							<div id="filesCount" class="prFloatLeft"><strong>0</strong> {t}Files{/t}</div>
							<div id="totalSize" class="prFloatLeft">{t}Total:{/t} <strong>0</strong> {t}Kb{/t}</div>       				</div>                     
				</div>
			</td>
		</tr>
		<tr>
...
<div class="prInnerTop prTCenter">
			...
			<span class="prIEVerticalAling"><span class="prIndentLeftSmall">{t}or{/t}</span><a class="prIndentLeftSmall" id="btnCancel1" href="#null" onClick="PGEApplication.hideUploadPanel(); return false;">{t}Cancel{/t}</a></span>
			</div>	
