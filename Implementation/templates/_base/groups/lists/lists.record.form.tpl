<div class="prListBox prIndentBottom prInnerBottom">
	<div class="prDropHeader prIndentTop">
		...
		{if $action=='edit'}
		<div class="prHeaderTools"><a class="freeClass" href="#" onclick="xajax_list_{$action}_save({$id},xajax.getFormValues('record_form_{$id}')); return false;">{t}Close{/t}</a></div>  
		{/if}
	</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						{linkbutton name=$in_button onclick="xajax_list_`$action`_save(`$id`,xajax.getFormValues('record_form_`$id`')); return false;"}
					</td>
					<td>&#160;</td>
				</tr>                                                                                                                                                                                                                  
			</tbody>
