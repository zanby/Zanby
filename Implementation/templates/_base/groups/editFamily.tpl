...
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCFamilyMemberIndex.class.js"></script>
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCGroupMembers.class.js"></script>
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCFamilyPeople.class.js"></script>
...
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCFamilyLists.class.js"></script>
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCFamilyIcons.class.js"></script>
...
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCFamilyEvents.class.js"></script>
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCFamilyAvatar.class.js"></script>
...
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCRoundInfo.class.js"></script>
<script type="text/javascript" src="{$JS_URL}/content_objects/DDCRoundEvents.class.js"></script>
