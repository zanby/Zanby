...
<table class="prForm">
	...
	<tr>
		...
		{t var='button'}Send{/t}
		{linkbutton onclick = "if(document.getElementById('send_xlink').value=='1') xajax_sendMessageDo(xajax.getFormValues('sendMessageForm')); document.getElementById('send_xlink').value='0';return false;" id="SendMessageOK" name=$button}</span> 
