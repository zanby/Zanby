			...
			<div class="prInnerTop">
				<div class="prClr3">
					...
					<div class="prHeaderTools"><span>
							<a class="prCOHeaderClose" onclick="family_discussion_remove_section('{$cloneId}',{$iter});return false;" href="#Show" title="remove section">&nbsp;</a>
					</span></div>
				</div>
		...
		{if $discussionsShowThreadsNumber && ($discussionsDisplayMostActive || $discussionsDisplayMostRecent)}
				...
				<div id="discussion_tab_0_{$cloneId}_{$currkey}" style="display:block;" class="prSubNav prNoBorder">
					...
					<ul class="prClr3">
						...
						{if $discussionsDisplayMostRecent}
							<li><a class="prNoBorder" href="#null" onclick="switchDiscussionsTab('{$cloneId}','{$currkey}',1); return false;">{t}Most Recent{/t}</a></li>
						{/if}
					</ul>
			...
			{if $discussionsDisplayMostRecent}
				<div id="discussion_tab_1_{$cloneId}_{$currkey}" {if $discussionsDisplayMostActive}style="display:none;"{else}style="display:block;"{/if} class="prSubNav prNoBorder">
					...
					<ul class="prClr3">
						{if $discussionsDisplayMostActive}
							<li><a class="prNoBorder" href="#null" onclick="switchDiscussionsTab('{$cloneId}','{$currkey}',0); return false;">{t}Most Active{/t}</a></li>
						{/if}
