		...
		<tbody>
			<tr>
				<td class="prInnerSmall">
					...
					<select class="prFullWidth" id='list_display_type_select_{$cloneId}' onchange="list_display_type_select_change('{$cloneId}', this.selectedIndex);return false;">
			...
			{else}
				...
				<tr>
					<td class="prTBold"><label for="list_display_number_in_each_category_{$cloneId}">{t}Set the number of list items you wish to display before the &#34;more&#34; link:{/t}</label></td>
				</tr>
				<tr>
					<td>
						<select class="prAutoWidth" id="list_display_number_in_each_category_{$cloneId}" onchange="set_list_display_number_in_each_category(this.value, '{$cloneId}');return false;">
...
{/if}
{include file="content_objects/ddGroupLists/light_block_narrow.tpl"}
