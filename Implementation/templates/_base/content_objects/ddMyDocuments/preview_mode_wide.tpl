<div class="themeA"> 
    ...
    <div class=" prInnerTop prCOCentrino prClr3">
                ...
                <tr> {foreach name=documents from=$documents_ids item=id key=key}
                    ...
                    <td>
                        ...
                        <div class="prTCenter" id="document_{$cloneId}_{$key}"> {if $id}
                            <!-- -->
                            <div>
                                <a href="{$currentUser->getUserPath("docget/docid")|cat:$documents_objects[$key]->getId()}"><img src="{$documents_objects[$key]->getImageFileNameByExtension($documents_objects[$key]->getFileExt(), 'big')}" align="top" /></a>
                                <img src="{$AppTheme->images}/decorators/spacer.gif" alt="" title="" width="15" />
                            </div>
                            <a href="#null">{$documents_objects[$key]->getOriginalName()|truncate:16|escape:'html'}</a>
                            <br />
