        ...
        <ul class="prClr3">
            ...
            <li class="prClr3">
                ...
                <div class="prFloatLeft">
                    ...
                    <div>
                        <a href="{$BASE_URL}/{$LOCALE}/search/members/preset/new/keywords/city:'{$item->getCity()->name|escape:htmlall}'/">{$item->getCity()->name|escape:htmlall}</a>,
                        <a href="{$BASE_URL}/{$LOCALE}/search/members/preset/new/keywords/state:'{$item->getCity()->getState()->name|escape:htmlall}'/">{$item->getCity()->getState()->name|escape:htmlall}</a>
