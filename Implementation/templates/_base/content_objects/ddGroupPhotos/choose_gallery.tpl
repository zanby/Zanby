...
<table width=220 border=0 cellpadding="2" cellspacing="2" align="center">
    ...
    <tr>
        <td width="150">
            <select name="gallery_select" id="gallery_select" style='width:220px; visibility:' onchange="xajax_ddMyPhotos_load_gallery(this.value); return false;">
    ...
    <tr>
        <td width=150>
            <div class="prInnerTop prText2">{t}Preview{/t}</div>
...
<table width="100" border="0" align="center">
    <tr>
        <td> 
		{t var="in_button"}Ok{/t}{linkbutton name=$in_button color="orange" onclick="$onclickattr"} </td>
		<td> {t}or{/t} <a href="#" onclick="popup_window.close(); return false;">{t}Cancel{/t}</a></td>
    </tr>
    {else}
    <tr>
        <td width=150>
