...
<div class="prInnerSmall">
    <table class="prForm">
        <tbody>
            ...
            <tr>
                <td>
                    <select class="prFloatLeft" id='display_gm_type_select_{$cloneId}' onchange="display_gm_type_select_change('{$cloneId}', this.selectedIndex);return false;">
            ...
            <tr>
                <td>
                    <select class="prFloatLeft" name="default_gm_index_sort_{$cloneId}" id="default_gm_index_sort_1_{$cloneId}" onchange="default_gm_index_sort_change('{$cloneId}', this.value);return false;">
            ...
            <tr>
                <td colspan="2">
                    <label class="prTBold" for="display_gm_number_in_each_region_{$cloneId}">
                    {t}Show top{/t}
                    </label>
...
<div class="themeA" id="light_{$cloneId}"> 
    {include file="content_objects/ddGroupMembers/light_block_wide.tpl"}
</div>	
