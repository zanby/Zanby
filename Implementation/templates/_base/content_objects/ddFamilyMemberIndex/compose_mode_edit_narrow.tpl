        ...
        <tbody>
            ...
            <tr>
                <td>
                    ...
                    <select id="display_fmi_number_in_each_region_{$cloneId}" onchange="set_fmi_display_number_in_each_region(this.value, '{$cloneId}');return false;" class="prAutoWidth">
...
<div class="themeA" id="light_{$cloneId}"> 
    {include file="content_objects/ddFamilyMemberIndex/light_block_narrow.tpl"}
</div>
