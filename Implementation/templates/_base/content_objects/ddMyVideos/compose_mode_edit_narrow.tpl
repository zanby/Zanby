...
<div class="prCO-subsettings">
    <div class="prCO-subsetting-slot">
        <label>{t}Galleries Display:{/t} </label>
       <select id="video_type_select_{$cloneId}" name="video_type" onchange="videoTypeSelectChange('{$cloneId}'); return false;" style="width:95%">
    ...
    <select id="show_type_select_{$cloneId}" name="show_type" onchange="showAsIconsChange('{$cloneId}',this.selectedIndex); return false;" style="width:95%">
    ...
    <select id="gallery_show_thumbnails_count_{$cloneId}" onchange="galleryShowThumbnailsCountChange('{$cloneId}');" name="gallery_show_thumbnails_count" style="width:95%" >
...
{include file="content_objects/ddMyVideos/light_block_narrow.tpl"}
