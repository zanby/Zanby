...
{include file="content_objects/ddGroupAvatar/light_block_narrow.tpl"}

<div class="prIndentLeft">
    <a class="prLink2" href="#null" onclick='xajax_select_avatar("{$cloneId}");return false;'>{t}Select photo{/t} &raquo;</a>
</div>
