...
<div class="prInnerSmall">
   ...
   <table cellspacing="0" cellpadding="0" class="prForm">
		<tbody>
			<tr>
				<td>
					<strong>{t}Title:{/t}</strong><br />
					<div class="ieInputFix">
					<input type="text" name="rss_title" id="rss_title_{$cloneId}" value="{$rss_title|escape:'html'}" onchange="changeRSSTitle('{$cloneId}', this.value);" />
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<strong>{t}URL:{/t}</strong><br />
					<div class="ieInputFix">
						<input type="text" name="rss_url" id="rss_url_{$cloneId}" value="{$rss_url|escape:'html'}" onchange="changeRSSUrl('{$cloneId}', this.value);" />
					</div>
				</td>
			</tr>
			<tr>
            ...
            <tr>
                <td><strong>{t}Headline Font:{/t}</strong><br />
            ...
            <tr>
                <td><strong>{t}Headline Font size:{/t}</strong><br />
            ...
            <tr>
                <td><strong>{t}Headline Color:{/t}</strong><br />
                    <div class="ieInputFix">
            ...
            <tr>
                <td><strong>{t}Description font:{/t}</strong><br />
            ...
            <tr>
                <td><strong>{t}Description Color:{/t}</strong><br />
                    <div class="ieInputFix">
            ...
            <tr>
                <td><strong>{t}Description Font size:{/t}</strong><br />
