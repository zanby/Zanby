...
{form_errors_summary}
{form_hidden name='list' value=$list->getId()}
{form_hidden name='handle' value=1}
...
<div class="prTCenter prInnerTop">	
	...
	{/if}
    {linkbutton name=$buttonTitle link="#" onclick="SearchApplication.listAddToMy("|cat:$list->getId()|cat:", 1); return false;"}
