<?php
Warecorp::addTranslation('/modules/groups/xajax/lists/method.lists.refresh.php.xml');
    ...
    switch ($list->isSpecialView()) {
        case 1 :
            $template = 'groups/lists/lists.view.record.special.tpl';
            break;
        default:
            $template = 'groups/lists/lists.view.record.tpl';
            break;
    }
