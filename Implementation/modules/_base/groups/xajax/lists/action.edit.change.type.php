<?php
Warecorp::addTranslation('/modules/groups/xajax/lists/action.edit.change.type.php.xml');

    $AccessManager = Warecorp_List_AccessManager_Factory::create();
    
    $objResponse = new xajaxResponse();

//     if (!$AccessManager->canManageList($this->currentGroup, $this->_page->_user->getId())) {
