<?php
    Warecorp::addTranslation('/modules/groups/documents/xajax/action.documentShareFile.php.xml');
    ...
    if(isset($groupsList[$objDocument->getOwner()->getId()])) unset($groupsList[$objDocument->getOwner()->getId()]);
        ...
        if ($objDocument->getOwner() instanceof Warecorp_Group_Base && $objDocument->getOwner()->getId() == $this->currentGroup->getId()) { 
    ...
    $content = $this->view->getContents('groups/documents/share.popup.tpl');
