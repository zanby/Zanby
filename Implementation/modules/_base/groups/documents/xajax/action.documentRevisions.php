<?php
    Warecorp::addTranslation('/modules/groups/documents/xajax/action.documentRevisions.php.xml');    
    ...
    /* get revisions list */
        ...
        $size = 15;
        $link = $this->currentGroup->getGroupPath('documentRevisions', false);
    ...
    /* open window */        
        ...
        $content = $this->view->getContents('groups/documents/documents.revisions.template.tpl');        
