<?php
Warecorp::addTranslation('/modules/groups/gallery/xajax/action.galleryUdateCommentDo.php.xml');
...
if ( $gallery->getId() !== null &&
    $photo->getId() !== null &&
    $comment->id !== null &&
    Warecorp_Photo_AccessManager_Factory::create()->canEditCommentGallery($gallery, $comment, $this->currentGroup, $this->_page->_user) ) {
