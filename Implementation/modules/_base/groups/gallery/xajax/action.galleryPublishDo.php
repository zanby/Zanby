<?php
Warecorp::addTranslation('/modules/groups/gallery/xajax/action.galleryPublishDo.php.xml');
    ...
    $newGallery = Warecorp_Photo_Gallery_Factory::createByOwner($group);
    ...
    $objResponse->showAjaxAlert(Warecorp::t('Gallery Published'));