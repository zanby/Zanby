<?php
Warecorp::addTranslation('/modules/groups/calendar/action.event.edit.future.php.xml');
            ...
            */           
            if ( $eventInfo['isException'] ) {
                ...
                */
                ...
                $this->currentGroup->sendNewDataIsUploaded( $this->_page->_user, $objNewEvent, "EVENT", "DELETE", false );
...
//                    $mail->addParam('chObject', $objNewEvent);
...
//                }
            ...
            */           
                ...
                */
                ...
                /**
                * Event Tags :
                * Теги для копии нельзя изменять, они берутся от основного события
                */
