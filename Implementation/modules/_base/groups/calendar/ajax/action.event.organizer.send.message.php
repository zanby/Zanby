<?php
Warecorp::addTranslation('/modules/groups/calendar/ajax/action.event.organizer.send.message.php.xml');
    ...
    */
    ...
    if ( !$handle ) {
        ...
        $Content = $this->view->getContents('groups/calendar/ajax/action.event.organizer.send.message.tpl');
