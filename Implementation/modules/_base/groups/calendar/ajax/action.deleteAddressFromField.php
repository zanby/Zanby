<?php
Warecorp::addTranslation('/modules/groups/calendar/ajax/action.addAddressFromField.php.xml');
    ...
    if ( $mode == 'list' ) {
        ...
        if ( $this->currentGroup->getId() == $itemId ) {
            $objResponse->addScript('YAHOO.util.Dom.get("event_invite_entire_group").checked = false;');
        }
    }
