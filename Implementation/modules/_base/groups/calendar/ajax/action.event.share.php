<?php
Warecorp::addTranslation('/modules/groups/calendar/ajax/action.event.share.php.xml');
    ...
    */
    ...
    if ( !Warecorp_ICal_AccessManager_Factory::create()->canShareEvent($objEvent, $this->currentGroup, $this->_page->_user ) ) {
        $_SESSION['_calendar_']['_confirmPage_']['confirmMode'] = 'ERROR';
        $_SESSION['_calendar_']['_confirmPage_']['eventId'] = null;
    ...
    if ( !$handle ) {
        $sharedGroups = $objEvent->getSharing()
                                 ...
                                 ->getList();
        $sharedGroups[] = $this->currentGroup->getId();
        ...
        */
        ...
        $Content = $this->view->getContents('groups/calendar/ajax/action.event.share.tpl');
