<?php
Warecorp::addTranslation('/modules/groups/calendar/ajax/action.event.attach.list.php.xml');
    ...
    if ( !$handle ) {
        ...
        $this->view->form = $form;
        $content = $this->view->getContents('groups/calendar/ajax/action.event.attach.list.tpl');
        ...
        if ( $mode == 'ADD' ) {
            ...
            $content = $this->view->getContents('groups/calendar/action.event.template.lists.tpl');
