<?php
Warecorp::addTranslation('/modules/groups/calendar/ajax/action.venue.search.form.php.xml');
...
$aCreatedBy = array('anyone'            => Warecorp::t('Anyone'),
...
if (!empty($aParams)){
	$searchObj = new Warecorp_Venue_Search( $this->_page->_user );
...
$output = $this->view->getContents ( 'groups/calendar/venues.search.index.tpl' ) ;
