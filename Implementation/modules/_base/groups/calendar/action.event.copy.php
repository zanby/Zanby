<?php
    Warecorp::addTranslation('/modules/groups/calendar/action.event.copy.php.xml');
    ...
    * Init Form Object
    */
    $formURL = $this->currentGroup->getGroupPath('calendar.event.copy.do/id/'.$objRequest->getParam('id').'/uid/'.$objRequest->getParam('uid'));
...
//            }
            ...
            */
            ...
            $objEventInvite->setReceiveNoRsvpEmail($objRequest->getParam('event_allow_guests_invitation', 0));
            $objEventInvite->setAllowGuestToInvite($objRequest->getParam('receive_no_rsvp_email', 0));
    ...
    */
    ...
    $this->view->bodyContent = 'groups/calendar/action.event.copy.tpl';
