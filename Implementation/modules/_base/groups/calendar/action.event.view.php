<?php
    ...
    Warecorp::addTranslation('/modules/groups/calendar/action.event.edit.view.php.xml');
    ...
    */
    ...
    $this->_page->Xajax->registerUriFunction( "doCopyEvent", "/groups/calendarEventCopy/" );
    ...
    $this->_page->Xajax->registerUriFunction( "doEventSendMessage", "/groups/calendarEventSendMessage/" );
    $this->_page->Xajax->registerUriFunction( "doEventOrganizerSendMessage", "/groups/calendarEventOrganizerSendMessage/" );
    $this->_page->Xajax->registerUriFunction( "doEventRemoveGuest", "/groups/calendarEventRemoveGuest/" );
    $this->_page->Xajax->registerUriFunction( "doEventRemoveMe", "/groups/calendarEventRemoveMe/" );
    $this->_page->Xajax->registerUriFunction( "doChangeHost", "/groups/calendarEventChangeHost/" );
    $this->_page->Xajax->registerUriFunction( "doAddToMy", "/groups/calendarEventAddToMy/" );

    $this->_page->Xajax->registerUriFunction( "doExpandList", "/groups/calendarEventExpandList/" );
    $this->_page->Xajax->registerUriFunction( "doCollapseList", "/groups/calendarEventCollapseList/" );
    $this->_page->Xajax->registerUriFunction( "reloadCaptcha", "/ajax/reloadCaptcha/" );
...
//    }
    ...
    */
    ...
    // если смотрим евент коммитии

    $objUsedContext = $this->currentGroup;

    if ( Warecorp_ICal_AccessManager_Factory::create()->canManageEvent($objEvent, $this->currentGroup, $this->_page->_user) && $objRootEvent->getSharing()->getCount() ) {
        $showUnShareLink = ( $objRootEvent->getSharing()->getCount() ) ? true : false;
    } elseif ( $objRootEvent->getSharing()->isShared($objUsedContext) && Warecorp_ICal_AccessManager_Factory::create()->isHostPrivileges($objUsedContext, $this->_page->_user) ) {
    ...
    */
    ...
    $this->view->bodyContent = 'groups/calendar/action.event.view.tpl';
    $this->view->showUnShareLink = $showUnShareLink;
    $this->view->unShareGroupId = $objUsedContext->getId();
