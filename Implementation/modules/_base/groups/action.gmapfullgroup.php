<?php
Warecorp::addTranslation('/modules/groups/action.gmapfullgroup.php.xml');
...
$members_list = $membersListObj->getList();
...
$this->view->members_list = $members_list;


//print $this->view->getContents('gmap/singlegroup.tpl');
print $this->view->getContents('gmap/fullgroup.tpl');
exit;
