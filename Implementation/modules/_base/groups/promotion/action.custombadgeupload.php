<?php
Warecorp::addTranslation('/modules/groups/promotion/action.custombadgeupload.php.xml');

$objResponse = new xajaxResponse ( ) ;

$form = new Warecorp_Form('UploadForm','POST', $this->currentGroup->getGroupPath('custombadgeuploadsave/upload/1'));
$this->view->form = $form;

$Content = $this->view->getContents ( 'groups/promotion/custombadgeupload.tpl' ) ;
