<?php
Warecorp::addTranslation('/modules/groups/theme/xajax/action.selectAvatar.php.xml');
...
{
   $_gm = $this->currentGroup->getGroups()->setTypes('simple')->getList();
   foreach ( $_gm as &$_gr) {
        $groups[] = $_gr;
    } 
}
...
$this->view->a_thumbs_content = $this->view->getContents('groups/theme/avatar_thumbs_block.tpl');


$content = $this->view->getContents('groups/theme/choose_avatar.tpl');
