<?php
Warecorp::addTranslation('/modules/groups/videogallery/xajax/action.videogalleryShowTmbPage.php.xml');
...
$content = $this->view->getContents('groups/videogallery/'.VIDEOMODEFOLDER.'xajax.showtmb.tpl');
