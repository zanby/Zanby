<?php
Warecorp::addTranslation('/modules/groups/videogallery/xajax/action.videogalleryShareGroup.php.xml');
...
if ( $gallery->getId() !== null && 
    ...
    $groupsList = $this->_page->_user->getGroups()
                ...
                ->returnAsAssoc()
                ->setExcludeIds(array($this->currentGroup->getId()))
                ->getList();
    ...
    $Content = $this->view->getContents('groups/videogallery/'.VIDEOMODEFOLDER.'xajax.share.new.tpl');
