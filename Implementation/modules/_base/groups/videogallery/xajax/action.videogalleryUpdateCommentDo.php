<?php
Warecorp::addTranslation('/modules/groups/videogallery/xajax/action.videogalleryUpdateCommentDo.php.xml');
...
if ( $gallery->getId() !== null &&
    $video->getId() !== null &&
    $comment->id !== null &&
    Warecorp_Video_AccessManager_Factory::create()->canEditCommentGallery($gallery, $comment, $this->currentGroup, $this->_page->_user) ) {
