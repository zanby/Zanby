<?php
    Warecorp::addTranslation("/modules/users/videogallery/xajax/action.videogalleryEditshowpage.php.xml");
    ...
    $content = $this->view->getContents('users/videogallery/'.VIDEOMODEFOLDER.'template.edit.videos.rows.tpl');
