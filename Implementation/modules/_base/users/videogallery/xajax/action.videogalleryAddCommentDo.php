<?php
Warecorp::addTranslation("/modules/users/videogallery/xajax/action.videogalleryAddCommentDo.php.xml");
...
if ( $gallery->getId() !== null &&
    $video->getId() !== null &&
    Warecorp_Video_AccessManager_Factory::create()->canPostCommentsGallery($gallery, $this->currentUser, $this->_page->_user) ) {
    ...
    if (mb_strlen($message, 'UTF-8') > 2000) {
        ...
        if ( FACEBOOK_USED ) {
            ...
            $action_links[] = array('text' => 'View Video', 'href' => $this->currentUser->getUserPath('videogalleryView/id/'.$videoId));
