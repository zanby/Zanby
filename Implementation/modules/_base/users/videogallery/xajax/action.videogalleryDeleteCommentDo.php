<?php
Warecorp::addTranslation("/modules/users/videogallery/xajax/action.videogalleryDeleteCommentDo.php.xml");
...
if ( $gallery->getId() !== null && 
     $video->getId() !== null && 
     $comment->id !== null &&
     Warecorp_Video_AccessManager_Factory::create()->canDeleteCommentGallery($gallery, $comment, $this->currentUser, $this->_page->_user) ) {
