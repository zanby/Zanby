<?php
    Warecorp::addTranslation('/modules/users/documents/xajax/action.documentCheckOut.php.xml');    
        ...
        foreach ( $this->params['groups'] as $_docId ) {
            ...
            if ( null !== $objDocument->getId() ) {
                ...
                elseif ( $objDocument->getIsLink() ) {
                    ...
                    $objResponse->addDownloadFile($this->currentUser->getUserPath('docget/docid/'.$objDocument->getId()));
