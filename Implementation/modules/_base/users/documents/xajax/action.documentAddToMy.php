<?php
    Warecorp::addTranslation('/modules/users/documents/xajax/action.documentAddToMy.php.xml');
    ...
    if ( 0 != sizeof($this->params['groups']) ) {
        foreach ( $this->params['groups'] as $_docId ) {
            ...
            if ( null !== $objDocument->getId() ) {
                if (Warecorp_Document_AccessManager_Factory::create()->canViewDocument($objDocument, $this->currentUser, $this->_page->_user)) {
