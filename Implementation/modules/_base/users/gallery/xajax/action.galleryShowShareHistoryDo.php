<?php
    Warecorp::addTranslation("/modules/users/gallery/xajax/action.galleryShowShareHistoryDo.php.xml");
$objResponse = new xajaxResponse();

$gallery = Warecorp_Photo_Gallery_Factory::loadById($this->params['gallery_id']);

if ( $gallery->getId() !== null && 
     Warecorp_Photo_AccessManager_Factory::create()->canUnShareFromHistoryGallery($gallery, $this->currentUser, $this->_page->_user) ) {
