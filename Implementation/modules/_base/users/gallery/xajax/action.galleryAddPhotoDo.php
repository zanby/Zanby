<?php
    Warecorp::addTranslation("/modules/users/gallery/xajax/action.galleryAddPhotoDo.php.xml");
    ...
    if ( $gallery->getId() !== null && 
         $photo->getId() !== null &&
         Warecorp_Photo_AccessManager_Factory::create()->canCopyGallery($gallery, $gallery->getOwner(), $this->_page->_user) ) {
