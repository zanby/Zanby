<?php
Warecorp::addTranslation("/modules/users/contentblocks/ddMyPhotos/action.selectGallery.php.xml");
$objResponse = new xajaxResponse();

$galleries = $this->_page->_user->getGalleries()->setPrivacy(0)->setSharingMode('own')->getList();
...
$content = $this->view->getContents('content_objects/ddMyPhotos/choose_gallery.tpl');
