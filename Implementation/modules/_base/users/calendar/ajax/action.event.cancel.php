<?php
    ...
    Warecorp::addTranslation("/modules/users/calendar/xajax/action.event.cancel.php.xml");
    ...
    */
    ...
    if ( !$handle ) {
        ...
        $Content = $this->view->getContents('users/calendar/ajax/action.event.cancel.tpl');
        ...
        if ( $view == 'month' ) $objResponse->addRedirect($this->currentUser->getUserPath('calendar.month.view'));
        elseif ( $view == 'active' ) $objResponse->addRedirect($this->currentUser->getUserPath('calendar.list.view'));
        else $objResponse->addRedirect($this->currentUser->getUserPath('calendar.list.view/mode/expired'));
    }
