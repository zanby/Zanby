<?php
    ...
    if ( null === $objRequest->getParam('mode', null) ) {
        ...
        $this->view->linkURL = $this->currentUser->getUserPath('calendar.event.apply.request/id/'.$request->getId().'/mode');
        $this->view->bodyContent = 'users/calendar/action.event.apply.request.tpl';
    } else {
