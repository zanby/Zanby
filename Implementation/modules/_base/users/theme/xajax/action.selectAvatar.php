...
Warecorp::addTranslation("/modules/users/theme/xajax/action.selectAvatar.php.xml");
...
$this->view->a_thumbs_content = $this->view->getContents('users/theme/avatar_thumbs_block.tpl');

$content = $this->view->getContents('users/theme/choose_avatar.tpl');
