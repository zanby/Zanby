<?php
    Warecorp::addTranslation('/modules/adminarea/action.families.php.xml');
    $items_per_page = 10;
    ...
    if ( isset($this->params['id']) ) {
        ...
        $form = new Warecorp_Form('sForm', 'POST', $this->admin->getAdminPath('families/id/'.$this->params['id']));
     ...
     */    
        ...
        $this->view->bodyContent    = "adminarea/action.families.tpl";
    }
