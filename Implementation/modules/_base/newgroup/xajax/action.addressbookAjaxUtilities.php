<?php
    ...
    Warecorp::addTranslation('/modules/newgroup/xajax/action.addressbookAjaxUtilities.php.xml');
    ...
    $contacts = $userAddressbookContactList->getList(array(Warecorp_User_Addressbook_eType::USER, Warecorp_User_Addressbook_eType::CUSTOM_USER, Warecorp_User_Addressbook_eType::GROUP_MEMBER,Warecorp_User_Addressbook_eType::FRIEND));
    ...
    $contactsCount = $userAddressbookContactList->getCount(array(Warecorp_User_Addressbook_eType::USER, Warecorp_User_Addressbook_eType::CUSTOM_USER, Warecorp_User_Addressbook_eType::GROUP_MEMBER,Warecorp_User_Addressbook_eType::FRIEND)); 
