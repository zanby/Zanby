<?php
    function smarty_function_mainnav_anonymous($params, &$smarty)
    {
		Warecorp::addTranslation('/plugins/function.mainnav_anonymous.php.xml');
    	/**
        ...
        if ( IMPLEMENTATION_TYPE == 'ESA' ) {
            ...
            $pageUser      = (boolean) ( $MOD_NAME == "users" && (!$user || !$currentUser || $currentUser->getId() != $user->getId()) && $bodyContent != 'users/familylanding.tpl');
         ...
         */
	        ...
	        //  News
	        if ( $pageGroups ) { 
	            $out .= '<li class="znCurrent"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/groups/"><span>'.Warecorp::t('Groups').'</span></a></li>';
	        } elseif ( $pageHome ) {
	            $out .= '<li class="znNoBorder"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/groups/"><span>'.Warecorp::t('Groups').'</span></a></li>';
	        } else {
	            $out .= '<li><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/groups/"><span>'.Warecorp::t('Groups').'</span></a></li>';
	        }
	        //  Events
            if ( $pageEvents ) { 
                $out .= '<li class="znCurrent"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/events/"><span>'.Warecorp::t('Events').'</span></a></li>';
            } elseif ( $pageGroups ) { 
                $out .= '<li class="znNoBorder"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/events/"><span>'.Warecorp::t('Events').'</span></a></li>';
            } else {
                $out .= '<li><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/events/"><span>'.Warecorp::t('Events').'</span></a></li>';
            }
	        //  Video
	        if ( $pageVideo ) { 
	            $out .= '<li class="znCurrent"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/videos/"><span>'.Warecorp::t('Videos').'</span></a></li>';
	        } elseif ( $pageEvents ) { 
	            $out .= '<li class="znNoBorder"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/videos/"><span>'.Warecorp::t('Videos').'</span></a></li>';
	        } else {
	            $out .= '<li><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/videos/"><span>'.Warecorp::t('Videos').'</span></a></li>';
	        }
	        //  Photos
	        if ( $pagePhotos ) { 
	            $out .= '<li class="znCurrent"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/photos/"><span>'.Warecorp::t('Photos').'</span></a></li>';
	        } elseif ( $pageVideo ) { 
	            $out .= '<li class="znNoBorder"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/photos/"><span>'.Warecorp::t('Photos').'</span></a></li>';
	        } else {
	            $out .= '<li><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/photos/"><span>'.Warecorp::t('Photos').'</span></a></li>';
	        }
	        //  Lists
	        if ( $pageLists ) { 
	            $out .= '<li class="znCurrent"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/lists/"><span>'.Warecorp::t('Lists').'</span></a></li>';
	        } elseif ( $pagePhotos ) { 
	            $out .= '<li  class="znNoBorder"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/lists/"><span>'.Warecorp::t('Lists').'</span></a></li>';
	        } else {
	            $out .= '<li><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/lists/"><span>'.Warecorp::t('Lists').'</span></a></li>';
	        }
	        //  Discussions
	        if ( $pageDiscussions ) { 
	            $out .= '<li class="znCurrent"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/discussion/"><span>'.Warecorp::t('Discussions').'</span></a></li>';
	        } elseif ( $pageLists ) { 
	            $out .= '<li class="znNoBorder"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/discussion/"><span>'.Warecorp::t('Discussions').'</span></a></li>';
	        } else {
	            $out .= '<li><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/discussion/"><span>'.Warecorp::t('Discussions').'</span></a></li>';
	        }
	        if ( $pageBlog ) { 
	            $out .= '<li class="znCurrent"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/blog/"><span>'.Warecorp::t('Blog').'</span></a></li>';
	        } elseif ( $pageDiscussions ) { 
	            $out .= '<li class="znNoBorder"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/blog/"><span>'.Warecorp::t('Blog').'</span></a></li>';
	        } else {
	            $out .= '<li><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/blog/"><span>'.Warecorp::t('Blog').'</span></a></li>';
	        }
	        //  Documents
	        if ( $pageDocuments ) { 
	            $out .= '<li class="znCurrent"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/documents/"><span>'.Warecorp::t('Documents').'</span></a></li>';
	        } elseif ( $pageBlog ) {
	            $out .= '<li class="znNoBorder"><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/documents/"><span>'.Warecorp::t('Documents').'</span></a></li>';
	        } else {
	            $out .= '<li><a href="http://'.BASE_HTTP_HOST.'/'.LOCALE.'/index/documents/"><span>'.Warecorp::t('Documents').'</span></a></li>';
	        }
	        $out .= '</ul>';
	        return $out;
        }
