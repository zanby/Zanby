<?php
function smarty_block_TitlePane_Content($params, $content, &$smarty)
{
	Warecorp::addTranslation('/plugins/block.TitlePane_Content.php.xml');
    /**
     * End tag
     */
    if ( $content !== null ) {
