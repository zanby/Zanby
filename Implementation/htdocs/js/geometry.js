...
function getPopupCoordinats(x, y, e_id, pp_h, pp_w) {
    var scrollV = Geometry.getVerticalScroll( );
    var viewH   = Geometry.getViewportHeight( );
    var viewW   = Geometry.getViewportWidth( );
        
    if ( y - scrollV > viewH - pp_h ) { 
        y = y - ( pp_h + 35 ); 
    }
    ...
    document.getElementById( e_id ).style.top = y + 'px';
