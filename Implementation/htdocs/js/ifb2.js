...
document.write(' &nbsp; <a href="https://www.warecorp.com/bugzilla/enter_bug.cgi?product=' + ifbproject + '&long_desc_type=allwordssubstr&long_desc=&bug_file_loc_type=allwordssubstr&bug_file_loc='  +  ifbthisURL +'&version=' + ifbversion + '" target="new">Enter a bug</a><br /	><hr>Search Bugzilla: <form name="ifbke" method="get" id="ifbke" class="ifbke"><input name="ifbkeyword" type="text" value="keyword"  onkeypress="if (event.keyCode == 13)ifbGoSearch();" onclick="this.value=ifbnon;"/><a href="" onClick="ifbGoSearch();">Go</a></form> ');
