...
//				alert(container.innerHTML);
				container.innerHTML = "<span id='" + this.settings.button_placeholder_id + "'></span>";
// 			    tmpElement = document.createElement('span');
// 			    tmpElement.id = this.settings.button_placeholder_id;
// 				container.replaceChild(movieElement, tmpElement);
