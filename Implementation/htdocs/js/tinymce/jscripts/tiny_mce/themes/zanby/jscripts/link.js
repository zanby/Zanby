...
function init() {
	...
	document.getElementById('hrefbrowsercontainer').innerHTML = getBrowserHTML('hrefbrowser','href','file','theme_zanby_link');
	...
	addClassesToList('styleSelect', 'theme_zanby_link_styles');
...
function insertLink() {
	...
	tinyMCE.themes['zanby']._insertLink(href, target, title, dummy, style_class);
	tinyMCEPopup.close();
}
