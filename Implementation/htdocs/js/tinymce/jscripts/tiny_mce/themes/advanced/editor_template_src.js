...
var TinyMCE_AdvancedTheme = {
	...
	_buttons : [
		...
		['image', '{$lang_bold_img}', 'lang_image_desc', 'mceImage', true],
	...
	getControlHTML : function(button_name) {
		...
		switch (button_name) {
			...
			case "|":
			case "separator":
				return '<img src="'+AppTheme.images+'/decorators/separator.gif" width="2" height="20" class="mceSeparatorLine" alt="" />';

			case "spacer":
				return '<img src="'+AppTheme.images+'/decorators/separator.gif" width="2" height="15" border="0" class="mceSeparatorLine" style="vertical-align: middle" alt="" />';
