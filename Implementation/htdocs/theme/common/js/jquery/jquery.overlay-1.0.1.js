...
(function($) { 
	...
	function Overlay(el, opts) {
		...
		$.extend(self, {
			...
			load: function(top, left, optFinish) {
                ...
                if ( optFinish && optFinish.width ) {
                    this.getContent().width(optFinish.width);
                    oWidth = o.outerWidth({margin:true});
                }
                if ( optFinish && optFinish.height ) {
                    this.getContent().height(optFinish.height);
                ...
                if ( optFinish && optFinish.top ) opts.finish.top = optFinish.top;
                if ( optFinish && optFinish.left ) opts.finish.left = optFinish.left;
